# DevMind — referencia técnica completa

> Documentación técnica ampliada. Para una introducción, instalación rápida y enlaces principales, consulta el [README del proyecto](../README.md).
...
Documentación: [presentación](DevMind_Slides.pdf) · [README principal](../README.md) · [repositorio del frontend](https://github.com/Calitos10/Devmind-Frontend)
...
- **Sabe decir "no lo sé".** Un umbral de distancia (`RAG_MAX_DISTANCE`) descarta los fragmentos irrelevantes. Si no queda ninguno, DevMind responde que no tiene información en lugar de inventar. Ver [§13](#13-engineering-decisions).
...
>
> Como para **probar la API en el despliegue** desde el navegador (subir un ZIP, indexar y preguntar) hace falta una interfaz, he **generado un frontend web (React + Vite) con IA** a partir de un _prompt_ propio y específico. El diseño de producto y los flujos son míos; la implementación del frontend la produjo la IA.
...
> **Estado actual:** el frontend está publicado en Vercel y la API, junto con PostgreSQL/pgvector, está desplegada en Railway. Las URLs públicas están en el [README principal](../README.md).
...
| Limitación                                                                                                                  | Estado                                                                                          |
| --------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| **La purga de invitados no es automática.** `purge-guests` existe y funciona, pero debe lanzarse a mano o por cron externo. | Un scheduler interno queda como mejora.                                                         |
...
| Documento | Contenido |
| --------- | --------- |
| [`README.md`](../README.md) | Introducción, inicio rápido y visión resumida del proyecto |
| [`TECHNICAL_REFERENCE.md`](TECHNICAL_REFERENCE.md) | Referencia técnica completa |
| [`DevMind_Slides.pdf`](DevMind_Slides.pdf) | Presentación del proyecto |
